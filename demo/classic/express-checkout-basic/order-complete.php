    ...
    <div class="container">
      ...
      <div class="cart-intro">
        <p>We have now reached the final thank you / receipt page and the payment has been processed! We have added the PayPal transaction ID 
          to the Billing Information, which was provided in the <strong>DoExpressCheckoutPayment</strong> response.
        </p>
      </div>
        ...
        <div class="rv-info-card">
          ...
          <div class="rv-info-body">
            ...
            <div class="rv-info-row cp-txn-row">
              ...
              <span class="rv-info-value cp-txn-id"><?php echo !empty($_SESSION['paypal_transaction_id']) ? $_SESSION['paypal_transaction_id'] : ''; ?></span>
            </div>
          </div>
        </div>
...
<?php
  /* Destroy Session after Order Completion */
  session_destroy();
?>