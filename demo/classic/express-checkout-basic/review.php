  ...
  <main class="cart-main">
    <div class="container">
      ...
      <div class="cart-intro">
        <p>Here we display a final review to the buyer now that we've calculated shipping, handling, and tax.  The 
          billing and shipping information provided here is what we obtained in the <strong>GetExpressCheckoutDetails</strong> response.
        </p>
        <p>The payment has not been processed at this point because we have not yet called the final DoExpressCheckoutPayment API. That is what will 
          happen when we click the "<strong>Complete Order</strong>" button below.
        </p>
      </div>
      ...
      <div class="cart-items-card rv-items-card">
        <div class="cart-items-header">
          <h2>Order Items</h2>
          <?php if (!empty($_SESSION['shopping_cart']['ec_checkout_items'])) : ?>
        ...
        <div class="cart-table">
          ...
          <!-- Item Rows -->
          <?php if (!empty($_SESSION['shopping_cart']['ec_checkout_items'])) {
            foreach ($_SESSION['shopping_cart']['ec_checkout_items'] as $cart_item) { ?>
      ...
      <div class="rv-bottom-grid">
        ...
        <div class="rv-info-card">
          ...
          <div class="rv-info-body">
            <div class="rv-info-row">
              ...
              <span class="rv-info-value"><?php echo !empty($name) ? $name : ''; ?></span>
            </div>
            <div class="rv-info-row">
              <span class="rv-info-label">Email</span>
              <span class="rv-info-value"><?php echo !empty($_SESSION['email']) ? $_SESSION['email'] : ''; ?></span>
            </div>
          </div>
        </div>
        ...
        <div class="rv-info-card">
          ...
          <div class="rv-info-body">
            <div class="rv-info-row">
              <span class="rv-info-label">Name</span>
              <span class="rv-info-value"><?php echo !empty($_SESSION['shipping_name']) ? $_SESSION['shipping_name'] : ''; ?></span>
            </div>
            <div class="rv-info-row">
              <span class="rv-info-label">Address</span>
              <span class="rv-info-value"><?php echo !empty($_SESSION['shipping_street']) ? $_SESSION['shipping_street'] : ''; ?></span>
            </div>
            <div class="rv-info-row">
              ...
              <span class="rv-info-value">
                <?php if (!empty($line1)) echo $line1;
                if (!empty($line2)) echo ($line1 ? ' ' : '') . $line2;
                if (empty($line1) && empty($line2)) echo 'N/A';
                ?>
              </span>
            </div>
            <div class="rv-info-row">
              <span class="rv-info-label">Country</span>
              <span class="rv-info-value"><?php echo !empty($_SESSION['shipping_country_name']) ? $_SESSION['shipping_country_name'] : ''; ?></span>
            </div>
          </div>
        </div>
        ...
        <div class="rv-summary-card">
          ...
          <a href="DoExpressCheckoutPayment.php" class="rv-complete-btn">
