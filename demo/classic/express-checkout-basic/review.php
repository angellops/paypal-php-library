      ...
      <div class="container">
        ...
        <div class="cart-intro">
          <p>Here we display a final review to the buyer now that we've calculated shipping, handling, and tax. The
            billing and shipping information provided here is what we obtained in the
            <strong>GetExpressCheckoutDetails</strong> response.
          </p>
          <p>The payment has not been processed at this point because we have not yet called the final
            DoExpressCheckoutPayment API. That is what will
