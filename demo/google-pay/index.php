            ...
            <div class="col-md-5 column">
              <table class="table table-summary">
                <tbody>
                  ...
                  <tr>
                    <td class="paypalbtn" colspan="2"><div id="googlepay-button-container" data-amount="<?php echo $_SESSION['shopping_cart']['grand_total']; ?>" data-email="<?php echo $_SESSION['buyer_email']; ?>"></div></td>
                  </tr>
                </tbody>
              </table>
            </div>
