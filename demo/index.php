...
<html lang="en">
  ...
  <body>
      ...
      <div class="container hero-inner">
        <div class="hero-grid">
          <div>
            ...
            <p class="hero-description">Explore our extensive library of working payment integrations. Test drive different checkout flows, understand the buyer experience, and see exactly how the APIs function in a real-world environment.</p>
            <div class="hero-cta">
      ...
      <div class="banner-wrap">
        <div class="banner" id="deprecation-banner">
          ...
          <div class="banner-body">
            ...
            <p>Some demos in this catalog utilize PayPal's <strong>Classic APIs</strong> (NVP/SOAP). These APIs are considered legacy and may have limited support for new integrations. For new projects, we strongly recommend evaluating the modern REST APIs first. However, these demos remain available for developers maintaining existing integrations.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <!--- CATALOG --->
    <main class="catalog" id="demos" data-link-icon='<?php echo htmlspecialchars(inline_svg("assets/images/redirect-icon.svg")); ?>'>
      <div class="container">
        ...
        <div class="demo-section">
          <div class="section-header">
            ...
            <p class="section-desc">
              ...
              from basic payments to advanced flows like subscriptions, vaulting, multi-party, and alternative payment methods.
            </p>
          </div>
