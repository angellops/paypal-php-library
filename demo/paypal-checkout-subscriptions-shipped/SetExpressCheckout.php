...
$SECFields = array(
	...
	'returnurl' => $domain . 'demo/paypal-checkout-subscriptions-shipped/GetExpressCheckoutDetails.php', 		// Required.  URL to which the customer will be returned after returning from PayPal.  2048 char max.
	'cancelurl' => $domain . 'demo/paypal-checkout-subscriptions-shipped/', 					// Required.  URL to which the customer will be returned if they cancel payment on PayPal's site.
...
/**
 * Here we push our single $Payment into our $Payments array if api_mode is rest.
 */
if( $api_mode === 'rest' ) {
