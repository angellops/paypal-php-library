    ...
    <div class="container">
      <div class="row clearfix">
        <div class="col-md-12 column">
          ...
          <p class="main-info">Here we display a final review to the buyer now that we've calculated shipping, handling, and tax. The billing and shipping information provided here is what we obtained in the GetExpressCheckoutDetails response. We have also displayed the subscription information again with a final break-down of everything for the one-time and recurring payments.</p>
          <p class="main-info">Nothing has been processed at this point!  When the Complete Checkout button is clicked it will trigger the call to DoExpressCheckoutPayment to process the $38.97 one-time payment.  If this succeeds, it will then process the CreateRecurringPaymentsProfile request to create the subscription profile.</p>
            ...
            <div class="col-md-4 column">
              <table class="table table-summary">
                <tbody>
                  ...
                  <tr>
                    <td class="button-center" colspan="2"><a href="CreateRecurringPaymentsProfile.php" class="btn btn-success btn-lg" role="button">Complete Checkout</a></td>
                  </tr>
                </tbody>
              </table>
            </div>
