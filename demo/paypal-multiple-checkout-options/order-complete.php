...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>PayPal Multiple Checkout Options Demo | Order Complete | PHP Class Library | Angell EYE</title>
        ...
        <div class="container">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    ...
                    <p class="main-info">We have now reached the final thank you / receipt page and the payment has been processed! We have added the PayPal transaction ID to the Billing Information, which was provided in the response.</p>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-4 column">
                            ...
                            <p>
                                <?php
                                    $paymentMode = isset($_SESSION['payment_mode']) ? $_SESSION['payment_mode'] : 'paypal';
                                    $paymentSources = [
                                        'guest'  => 'Guest Checkout Payments',
                                        'paypal' => 'PayPal',
                                        'paylater' => 'PayPal - Pay Later',
                                        'venmo'  => 'Venmo',
                                    ];

                                    $paymentSource = isset($paymentSources[$paymentMode]) ? $paymentSources[$paymentMode] : 'Advanced Credit/Debit Cards (ACDC)';
                                    $firstName = isset($_SESSION['first_name']) ? $_SESSION['first_name'] : (isset($_SESSION['payer']['firstname']) ? $_SESSION['payer']['firstname'] : '');
                                    $lastName  = isset($_SESSION['last_name']) ? $_SESSION['last_name'] : (isset($_SESSION['payer']['lastname']) ? $_SESSION['payer']['lastname'] : '');
                                    $email     = isset($_SESSION['email']) ? $_SESSION['email'] : (isset($_SESSION['payer']['email']) ? $_SESSION['payer']['email'] : '');
                                    $phone     = isset($_SESSION['phone_number']) ? $_SESSION['phone_number'] : (isset($_SESSION['payer']['phonenumber']) ? $_SESSION['payer']['phonenumber'] : '');
                                    ...
                                    echo '<strong>Transaction ID: </strong>' . $_SESSION['paypal_transaction_id'] . '<br />
                                    <span style="display:block; width:75%;"><strong>Payment Source: </strong>' . $paymentSource . '</span>';
                                ?>
                            </p>
                        </div>
                        <div class="col-md-4 column">
