...
$_SESSION['shopping_cart'] = array(
  'checkout_options_items' => $checkout_options_items,
  'subtotal' => 40.5,
  'shipping' => 15,
  'handling' => 10.5,
  'tax' => 4,
...
<html lang="en">
  <head>
    ...
    <script src="multicheckout.js"></script>
  </head>
  <body>
    <!-- HEADER -->
    ...
    <main class="cart-main">
      <div class="container">
        ...
        <div class="cart-intro">
          <p>This demo showcases multiple PayPal checkout options including PayPal Wallet, Guest Checkout (Debit/Credit Cards), Venmo, Pay Later, 
            and Direct Card Payments, allowing customers to choose their preferred payment method during checkout.
          </p>
        </div>
        ...
        <div class="cart-layout">
          ...
          <section class="cart-items-card">
            ...
            <div class="cart-table">
              ...
              <!-- Item Rows -->
              <?php foreach ($_SESSION['shopping_cart']['checkout_options_items'] as $cart_item) { ?>
          ...
          <aside class="cart-summary">
            <div class="summary-card">
              ...
              <!-- PayPal Button -->
              <div id="multicheckout-container" data-checkout='<?php echo json_encode($checkoutData); ?>'>
                <div id="paypalMessage"></div>
                <div class="paylater-message">
                  <paypal-message auto-bootstrap
