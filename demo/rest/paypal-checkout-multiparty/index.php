...
$_SESSION['shopping_cart'] = [
  'buyer_email' => 'paypal-buyer@angelleye.com',
	'multiparty_items' => $multiparty_items,
	'subtotal' => 15.00,
	'shipping' => 0,
	'handling' => 0,
	'tax' => 0,
    ...
    <main class="cart-main">
      <div class="container">
        ...
        <div class="cart-intro">
          <p>Here we are using a basic shopping cart for display purposes. With the PayPal Parallel Payment, the first item’s payment will go 
            to one PayPal account while the second item’s payment goes to a separate PayPal account.
          </p>
          <p>We are assuming that we have not collected any billing or shipping information from the buyer yet because we'll be obtaining those 
