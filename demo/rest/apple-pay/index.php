    ...
    <main class="cart-main">
      <div class="container">
        ...
        <div class="cart-intro">
          <p>Here we are using a basic shopping cart for display purposes. The payment request sent to Apple Pay contains only the total amount,
            with no individual line-item details. Billing and shipping information is collected by Apple Pay during checkout and made available 
            to the site once the user authorizes the payment.
          </p>
        </div>
        ...
        <div class="cart-layout">
          ...
          <section class="cart-items-card">
            <div class="cart-items-header">
              ...
              <span class="cart-count">
                <?php echo count($_SESSION['shopping_cart']['applepay_items']); ?> items
              </span>
            </div>
            ...
            <div class="cart-table">
              ...
              <!-- Item Rows -->
              <?php foreach ($_SESSION['shopping_cart']['applepay_items'] as $cart_item) { ?>
          ...
          <aside class="cart-summary">
            <div class="summary-card">
              ...
              <!-- PayPal Button -->
              <div id="applepay-container-main" data-amount="<?php echo $_SESSION['shopping_cart']['grand_total']; ?>" data-email="<?php echo $_SESSION['buyer_email']; ?>">
