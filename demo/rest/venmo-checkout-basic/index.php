...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>PayPal Venmo Checkout Basic Demo | PHP Class Library | Angell EYE</title>
    ...
    <main class="cart-main">
      <div class="container">
        ...
        <div class="cart-intro">
          <p>Here we are using a basic shopping cart for display purposes, however, for this basic demo, all we are sending to PayPal is the 
            order total without any line item details. We are assuming that we have not collected any billing or shipping information from the 
            buyer yet because we'll be obtaining those details from PayPal/Venmo after the user logs in and is returned back to the site.
          </p>
        </div>
