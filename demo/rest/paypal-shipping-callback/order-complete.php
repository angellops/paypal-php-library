...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>PayPal Checkout Shipping Callback | Order Complete | PHP Class Library | Angell EYE</title>
    ...
    <main class="cart-main">
      <div class="container">
        ...
        <div class="cart-intro">
          <p>We have now reached the final thank you/receipt page, and the payment has been successfully processed. The PayPal transaction ID has been added to the Billing Information as received in the <strong>getOrder</strong> response. Additionally, the order total was recalculated after applying shipping, handling, and tax via the shipping callback URL, and the updated amount was used for the final transaction.
          </p>
        </div>
        ...
        <div class="cart-items-card rv-items-card">
          <div class="cart-items-header">
            <h2>Order Items</h2>
            <?php if (!empty($_SESSION['shopping_cart']['callback_items'])): ?>
          ...
          <div class="cart-table">
            ...
            <!-- Item Rows -->
            <?php if (!empty($_SESSION['shopping_cart']['callback_items'])) {
              foreach ($_SESSION['shopping_cart']['callback_items'] as $cart_item) { ?>
