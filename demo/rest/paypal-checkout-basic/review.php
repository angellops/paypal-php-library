...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>PayPal Checkout Basic Demo | Order Review | PHP Class Library | Angell EYE</title>
    ...
    <main class="cart-main">
      <div class="container">
        ...
        <div class="cart-intro">
          <p>Here we display a final review to the buyer now that we've calculated shipping, handling, and tax. The billing and shipping information 
            provided here is what we obtained in the <strong>getOrder</strong> response.
          </p>
        </div>
