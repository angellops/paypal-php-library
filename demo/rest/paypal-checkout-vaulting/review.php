    ...
    <main class="cart-main">
      <div class="container">
        ...
        <div class="cart-intro">
          <p>Here we display a final review for the buyer after retrieving the order details from PayPal.
          </p>
          <p>The billing and shipping information shown here has been returned from PayPal after the buyer approved the 
            order. We have also calculated shipping, handling, and tax before presenting the final summary.
          </p>
