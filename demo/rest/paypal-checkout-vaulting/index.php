...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>PayPal Checkout Vaulting (Billing Agreement) Demo | PHP Class Library | Angell EYE</title>
    ...
    <main class="cart-main">
      <div class="container">
        ...
        <div class="cart-intro">
          <p>Here we are using a basic shopping cart for display purposes. In this demo, we create an order with PayPal 
            using the order details.
          </p>
          <p>We are not collecting any billing or shipping information on this page. These details will be provided by 
            PayPal after the buyer logs in and approves the order.
          </p>
          <p>In this flow, the buyer’s payment method will be securely saved using PayPal Vaulting. After approval, 
            we will capture the payment and generate a Vault ID, which can be used for future transactions without 
            requiring the buyer to re-enter their payment details.
          </p>
        </div>
        ...
        <div class="cart-layout">
          ...
          <section class="cart-items-card">
            ...
            <div class="cart-table">
              ...
              <!-- Item Rows -->
              <?php foreach ($_SESSION['shopping_cart']['vaulting_items'] as $cart_item) { ?>
