    ...
    <main class="cart-main">
      <div class="container">
        ...
        <div class="cart-intro">
          <p>We have now reached the final thank you / receipt page and the payment has been processed! We have added the Google Pay Transaction ID 
            to the Billing Information, which was provided in the <strong>getOrder</strong> response.
          </p>
        </div>
        ...
        <div class="cart-items-card rv-items-card">
          <div class="cart-items-header">
            <h2>Order Items</h2>
            <?php if (!empty($_SESSION['shopping_cart']['gpay_items'])): ?>
          ...
          <div class="cart-table">
            ...
            <!-- Item Rows -->
            <?php if (!empty($_SESSION['shopping_cart']['gpay_items'])) {
              foreach ($_SESSION['shopping_cart']['gpay_items'] as $cart_item) { ?>
            ...
            <div class="rv-info-body">
              ...
              <div class="rv-info-row">
                ...
                <span class="dnr-detail-value">
                  <span class="dnc-paypal-badge">Google Pay</span>
                </span>
              </div>
