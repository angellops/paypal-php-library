    ...
    <main class="cart-main">
      <div class="container">
        ...
        <div class="cart-intro">
          <p>We have now reached the final thank you / receipt page and the payment has been processed! We have added the 
            PayPal Transaction IDs (one for each transaction in the Parallel Payment split) to the Billing Information, 
            which was provided in the <strong>captureOrder</strong> response.
          </p>
        </div>
        ...
        <div class="rv-bottom-grid">
          ...
          <div class="rv-summary-card">
            ...
            <a href="trackOrder.php" class="rv-complete-btn" role="button">Track Order</a>
