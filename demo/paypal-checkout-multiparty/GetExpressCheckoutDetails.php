...
$Payment = array(
    ...
    'shiptophonenum' => $_SESSION['phone_number'],                   			// Required if you specify itemized L_TAXAMT fields.  Sum of all tax items in this order.
    'paymentaction' => 'Sale',
...
if( $api_mode === 'classic' &&  $PayPal->APICallSuccessful($PayPalResult['ACK']) )
{
    ...
    $_SESSION['shopping_cart']['multiparty_items'][0]['price_addon'] = $_SESSION['shopping_cart']['items'][0]['shipping'] + $_SESSION['shopping_cart']['items'][0]['handling'] + $_SESSION['shopping_cart']['items'][0]['tax'];
    ...
    $_SESSION['shopping_cart']['multiparty_items'][1]['price_addon'] = $_SESSION['shopping_cart']['items'][1]['shipping'] + $_SESSION['shopping_cart']['items'][1]['handling'] + $_SESSION['shopping_cart']['items'][1]['tax'];
