...
$SECFields = array(
    ...
    'returnurl' => $domain . 'demo/paypal-checkout-line-items/GetExpressCheckoutDetails.php',       // Required.  URL to which the customer will be returned after returning from PayPal.  2048 char max.
    'cancelurl' => $domain . 'demo/paypal-checkout-line-items/',          							    // Required.  URL to which the customer will be returned if they cancel payment on PayPal's site.
