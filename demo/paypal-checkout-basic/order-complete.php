...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>PayPal Checkout Basic Demo | Order Complete | PHP Class Library | Angell EYE</title>
      ...
      <div class="row clearfix">
        <div class="col-md-12 column">
          ...
          <table class="table table-items table-bordered">
            ...
            <tbody>
              <?php if(!empty($_SESSION['shopping_cart']['basic_items'])) { 
                foreach($_SESSION['shopping_cart']['basic_items'] as $cart_item) { ?>
                  <tr>
