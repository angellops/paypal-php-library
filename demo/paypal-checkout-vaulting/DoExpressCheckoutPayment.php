...
if($PayPal->APICallSuccessful($PayPalResult['ACK']))
{
     ...
     *
     * Here, we're only pulling out the PayPal transaction ID, billing agreement ID, and fee amount,
     * but you may refer to the API reference for all the additional parameters you have available at
     * this point.
     *
     * https://developer.paypal.com/docs/classic/api/merchant/DoExpressCheckoutPayment_API_Operation_NVP/
     */
    $_SESSION['paypal_billing_agreement_id'] = isset($PayPalResult['BILLINGAGREEMENTID']) ? $PayPalResult['BILLINGAGREEMENTID'] : '';
