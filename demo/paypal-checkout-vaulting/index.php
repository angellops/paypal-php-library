 ...
 */
$_SESSION['vaulting_items'][0] = array(
  'id' => '123-ABC',
  'name' => 'Widget',
  'qty' => '2',
  'price' => '9.99',
...
$_SESSION['vaulting_items'][1] = array(
  'id' => 'XYZ-456',
  'name' => 'Gadget',
  'qty' => '1',
  'price' => '4.99',
...
$_SESSION['shopping_cart'] = array(
	'vaulting_items' => $_SESSION['vaulting_items'],
	'subtotal' => 24.97,
	'shipping' => 0,
	'handling' => 0,
	'tax' => 0,
    ...
    <div class="container">
      <div class="row clearfix">
        <div class="col-md-12 column">
          ...
          <p class="main-info">Here we are using a basic shopping cart for display purposes, however, for this basic demo, all we are sending to PayPal is the order details. We are assuming that we have not collected any billing or shipping information from the buyer yet because we'll be obtaining those details from PayPal after the user logs in and is returned back to the site. After the successful login , we will create a billing agreement with the  buyer once he approve it.</p>
          <div class="demo-cred">
