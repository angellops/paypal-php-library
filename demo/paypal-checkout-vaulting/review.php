    ...
    <div class="container">
      <div class="row clearfix">
        <div class="col-md-12 column">
          ...
          <p class="main-info">Here we display a final review to the buyer now that we've calculated shipping, handling, and tax. The billing and shipping information provided here is what we obtained in the GetExpressCheckoutDetails response. You may also wish to include some sort of a message at this point about the fact that they have agreed to the billing agreement.</p>
          <p class="main-info">The payment has not been processed at this point because we have not yet called the final DoExpressCheckoutPayment API. That is what will happen when we click the "Complete Order" button below.</p>
